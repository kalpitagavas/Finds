    ...
    >
      ...
      <div className="relative z-10 bg-white p-8 rounded-[2.5rem] shadow-xl w-full max-w-[24rem]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full text-white flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium bg-orange-900 hover:bg-orange-950 focus:ring-2 focus:outline-none transition-all duration-300 hover:scale-105"
          >
        ...
        <p className="mt-4 text-center text-sm text-gray-600">
          ...
          <button
            onClick={toggleForm}
            className="font-medium text-orange-900 hover:text-orange-700"
          >
